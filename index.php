             ...
             <a href="#">
              ...
              foreach($files3 as $ssubfolder )
              {
                ...
                if(!is_dir($dir.$proj.'/'.$subfolder.'/'.$ssubfolder))
                  continue;
                ?>
                <li><a href="atlas-plots/index.php?project=<?php echo  $proj.'&subfolder='.$subfolder.'/'.$ssubfolder; ?>"><i class="fa fa-circle-o"></i><?php echo clean_string($ssubfolder); ?> </a></li>
              <?php
               // }
             }
               ?>
            ...
            <!-- Small boxes (Stat box) -->
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                  ...
                  <a href="atlas-plots/index.php?project=<?php echo  $project.'&subfolder='.$subfolder.'/'.$file; ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div><!-- ./col -->
